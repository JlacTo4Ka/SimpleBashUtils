...
# do
#   for var2 in -v -b -e -n -s -t #-E -T --number-nonblank --number --squeeze-blank
#   do
#         if [ $var != $var2 ]
#         then
...
#   for var2 in -v -b -e -n -s -t #-E -T --number-nonblank --number --squeeze-blank
#   do
#       for var3 in -v -b -e -n -s -t #-E -T --number-nonblank --number --squeeze-blank
#       do
...
#       for var3 in -v -b -e -n -s -t #-E -T --number-nonblank --number --squeeze-blank
#       do
#           for var4 in -v -b -e -n -s -t #-E -T --number-nonblank --number --squeeze-blank
#           do
